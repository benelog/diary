...
광일이 30개 이상의 USB 메모리로 녹음파일을 전달하는 장면도 의아하다. MP3 파일은 CD수준의 음질이라도 용량이 1분에 1MB 정도라고하니 1년치를 녹음해도 1MB * 60 * 24 * 365 = 525,600 MB, 525.6GB 밖에 안된다. 테라바이트급 USB 메모리 1개가 더 쌀 것 같은데, 번거롭게  30여개에 나눠서 담을 이유가 적어보인다.
...
사람이 사람을 좋아하는걸 판별하는데 복잡한 연산이 필요한 건 아니다. 어떤걸 받기를 기대하는지를 다른 사람들이  따져보기에 그런 표현을 둘러싼 상황이 복잡해진다는 생각이 들었다.
